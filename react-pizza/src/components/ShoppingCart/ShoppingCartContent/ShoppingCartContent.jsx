		...
		<div className='shopping-cart-content' style={styles}>
			<div className='shopping-cart-content-header'>
				<div className='shopping-cart-content-title'>
					...
					<div className='shopping-cart-content-title-text'>Кошик</div>
				</div>
				...
				>
					...
					<div className='shopping-cart-content-clear-text'>Очистити кошик</div>
				</Button>
			</div>
			...
			<div className='shopping-cart-content-footer'>
				...
				<Button className='shopping-cart-content-pay'>Сплатити зараз</Button>
			</div>
		</div>
	)
}
